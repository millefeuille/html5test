 ...
 * 汎用的に使えそうな自作関数のライブラリ
 *
 * @author mille <millefeuille007@gmail>
 */
...
SSLib.debugBreakPoint = function( outputConsole, outputAlert )
{
	...
	{
		case 1:
            //指定されたコンソールログに出力したいオブジェクトを設定
			dstConsole = outputConsole;
			break;
			
		case 2:
            //指定されたコンソールログに出力したいオブジェクトと，アラートウインドウに出力したいオブジェクトを設定
			dstConsole = outputConsole;
